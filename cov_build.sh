...
############################
# Build entservices-messagecontrol
echo "buliding entservices-messagecontrol"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-messagecontrol \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-messagecontrol --target install
echo "======================================================================================"
exit 0
